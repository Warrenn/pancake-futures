...
function calculateNetEquity(basePosition: Position, quotePosition: Position, price: float): number {
...
async function executeTrade() {
    ...
    if (initialEquity == 0) initialEquity = calculateNetEquity(position, quotePosition, price);
