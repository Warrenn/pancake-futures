...
async function adjustEquity(spotEquity: number) {
    ...
    let target = floor((availiableUnified + spotEquity) / 3, quotePrecision);
    let amount = (target * 2) - availiableUnified;
